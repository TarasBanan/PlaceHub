...
type TranslationDictionary = {
  nav: { home: string; catalog: string; collections: string; pricing: string; owners: string; about: string; contacts: string; login: string };
  ...
  home: { reviewsTitle: string; faqTitle: string; openAnswer: string };
...
export const translations: Record<Locale, TranslationDictionary> = {
  ru: {
    nav: { home: 'Главная', catalog: 'Каталог', collections: 'Подборки', pricing: 'Услуги', owners: 'Для владельцев', about: 'О сервисе', contacts: 'Контакты', login: 'Войти' },
    ...
    home: { reviewsTitle: 'Отзывы клиентов', faqTitle: 'FAQ', openAnswer: 'Открыть ответ' },
  ...
  en: {
    nav: { home: 'Home', catalog: 'Catalog', collections: 'Collections', pricing: 'Services', owners: 'For Owners', about: 'About', contacts: 'Contacts', login: 'Sign in' },
    ...
    home: { reviewsTitle: 'Client reviews', faqTitle: 'FAQ', openAnswer: 'Open answer' },
